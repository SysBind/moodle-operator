...
/*
Copyright 5778(2018) Sysbind Open Software Solutions.
...
func MoodleCreateCustomResourceDefinition(clientset apiextensionsclient.Interface) (*apiextensionsv1beta1.CustomResourceDefinition, error) {
	crd := &apiextensionsv1beta1.CustomResourceDefinition{
		ObjectMeta: metav1.ObjectMeta{
			Name: "moodleinstance.syscloud.co.il",
		},
		Spec: apiextensionsv1beta1.CustomResourceDefinitionSpec{
			Group:   "syscloud.co.il",			,
			Version: "v1",
			Scope:   apiextensionsv1beta1.NamespaceScoped,
			Names: apiextensionsv1beta1.CustomResourceDefinitionNames{
				Plural: "moodleinstance",
				Kind:   String,
			},
		},
	}
